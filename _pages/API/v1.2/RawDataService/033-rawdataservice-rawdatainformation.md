...
`filter`       | Contains one or multiple attribute conditions to restrict the query. Details can be found below.<br/>Filter syntax<br/>Basic module is attribute expression <br/> &lt;attribute&gt; &lt;operator&gt; &lt;value&gt; or <br/> &lt;attribute&gt; &lt;set operator&gt; (&lt;value1&gt;, &lt;value2&gt;, ...)<br/>
