...
<nobr><code>bool</code> caseSensitive </nobr> | Determines weather the search condition string comparison should be done case sensitive, case insensitive or (if not selected) by the current database default. <br> `caseSensitive=true` <br> `caseSensitive=false`
