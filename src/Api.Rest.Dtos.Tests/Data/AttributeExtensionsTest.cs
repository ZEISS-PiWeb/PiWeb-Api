...
namespace Zeiss.PiWeb.Api.Rest.Dtos.Tests.Data
{
	...
	public class AttributeExtensionsTest
	{
		...
		{
			// arrange
			var attribute = new Attribute( 1, 1 );
			var sut = new InspectionPlanPartDto { Attributes = new[] { attribute } };
		...
		{
			// arrange
			var attribute = new Attribute( 1, 1.23 );
			var sut = new InspectionPlanPartDto { Attributes = new[] { attribute } };
		...
		{
			// arrange
			var attribute = new Attribute( 1, DateTime.Now );
			var sut = new InspectionPlanPartDto { Attributes = new[] { attribute } };
		...
		{
			// arrange
			var attribute = new Attribute( 1, "2" );
		...
		public void Test_RemoveAttribute_Removes_Existing_Attribute()
		{
			...
			var sut = new InspectionPlanPartDto
			{
				Attributes = new[]
				{
					new Attribute( 1, "Test1" ),
					new Attribute( 2, "Test2" ),
					new Attribute( 3, "Test3" ),
					new Attribute( 4, "Test4" ),
				}
			};
		...
		public void Test_SetAttribute_Sets_Attribute_Value()
		{
			...
			{
				new Attribute( 1, "Test1" ),
				new Attribute( 22, "New Value" ),
			};

			// act
			sut.SetAttribute( new Attribute( 22, "New Value" ) );
