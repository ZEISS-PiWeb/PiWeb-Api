...
namespace Zeiss.PiWeb.Api.Rest.HttpClient.RawData
{
	...
	public static class RawDataServiceRestClientExtensions
	{
		...
		public static Task<RawDataInformationDto[]> ListRawDataForParts( [NotNull] this IRawDataServiceRestClient client, [CanBeNull] Guid[] partUuids, FilterCondition filter = null, CancellationToken cancellationToken = default )
		{
			if( client == null ) throw new ArgumentNullException( nameof( client ) );
			return client.ListRawData( RawDataEntityDto.Part, partUuids?.Select( u => u.ToString() ).ToArray(), filter, cancellationToken );
		}
		...
		/// <param name="cancellationToken">A token to cancel the asynchronous operation.</param>
		/// <exception cref="ArgumentNullException"><paramref name="client"/> is <see langword="null" />.</exception>
		public static Task<RawDataInformationDto[]> ListRawDataForCharacteristics( [NotNull] this IRawDataServiceRestClient client, [CanBeNull] Guid[] charateristicUuids, FilterCondition filter = null, CancellationToken cancellationToken = default )
		{
			if( client == null ) throw new ArgumentNullException( nameof( client ) );
			return client.ListRawData( RawDataEntityDto.Characteristic, charateristicUuids?.Select( u => u.ToString() ).ToArray(), filter, cancellationToken );
		}
		...
		{
			if( client == null ) throw new ArgumentNullException( nameof( client ) );
			return client.GetRawData( RawDataTargetEntityDto.CreateForPart( partUuid ), rawDataKey, cancellationToken: cancellationToken );
		}
		...
		{
			if( client == null ) throw new ArgumentNullException( nameof( client ) );
			return client.GetRawData( RawDataTargetEntityDto.CreateForCharacteristic( characteristicUuid ), rawDataKey, cancellationToken: cancellationToken );
		}
		...
		{
			if( client == null ) throw new ArgumentNullException( nameof( client ) );
			return client.DeleteRawData( RawDataTargetEntityDto.CreateForCharacteristic( characteristicUuid ), rawDataKey, cancellationToken );
		}
		...
		{
			if( client == null ) throw new ArgumentNullException( nameof( client ) );
			return client.DeleteRawData( RawDataTargetEntityDto.CreateForMeasurement( measurementUuid ), rawDataKey, cancellationToken );
		}
