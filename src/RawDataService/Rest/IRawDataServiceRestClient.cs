...
namespace Zeiss.IMT.PiWeb.Api.RawDataService.Rest
{
	...
	/// </summary>
	public interface IRawDataServiceRestClient
	{
		#region methods
		...
		/// <param name="cancellationToken">A token to cancel the hronous operation.</param>
		/// <returns></returns>
		Task<RawDataServiceFeatureMatrix> GetFeatureMatrix( CancellationToken cancellationToken = default( CancellationToken ) );
