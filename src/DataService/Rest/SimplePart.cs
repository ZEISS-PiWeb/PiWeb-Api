...
namespace Zeiss.IMT.PiWeb.Api.DataService.Rest 
{
	...
	/// <summary>
	/// This class represents the base class for parts inside the inspection plan structure. The concrete class for parts that also contains the part attributes is <see cref="InspectionPlanPart"/>.
	/// </summary>
